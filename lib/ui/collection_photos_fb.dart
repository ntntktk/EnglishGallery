                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: <
                                                                        ...
                                                                        IconButton(
                                                                          ...
                                                                          onPressed:
                                                                              () {
                                                                            Firestore.instance.collection('users').document(currentUserId).collection('memorizing-photos').document('$cid-${document['id']}').setData(document.data).then((onValue) {
                                                                              Firestore.instance.collection('users').document(currentUserId).collection('memorizing-photos').document('$cid-${document['id']}').updateData({
                                                                        ...
                                                                        IconButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            List<String>
                                                                                listDesc =
                                                                                List<String>.from(document['descList']);
                                                                            showModalBottomSheet(
                                                                                context: context,
