...
class CollectionsPageState extends State<UserPhotosPage>
  ...
  Future<List<Photo>> getCollectionPhotos({page: 1, perpage: 30}) async {
    final Response response = await get(
        "$baseUrl/collections/photos?alt_description&page=$page&per_page=$perpage",
        headers: headers);
        ...
        child: Scaffold(
          ...
          */
          body: TabBarView(
            ...
            children: <Widget>[
              StreamBuilder(
                stream: Firestore.instance.collection('photos').limit(10).snapshots(),
                      ...
                      ? Padding(
                          ...
                          child: GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                Fluttertoast.showToast(msg: '$document');
                                return AspectRatio(
                                    aspectRatio: document['width'] /
                                        document['height'],
                                    child: Container(
                                                ...
                                                ? InkWell(
                                                    ...
                                                    child: Stack(
                                                      children: <Widget>[
                                                        CachedNetworkImage(
                                                          imageUrl: isGrid
                                                              ? document['photoUrlSmall']
                                                              : document['photoUrlRegular'],
                                                          placeholder: (context,
                                                                  url) =>
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        showModalBottomSheet(
                                                                            context:
                                                                                context,
                                                                            builder: (context) =>
                                                                                InfoDescSheet(desc: document['desc']));
                                                                      },
                                                                    )
                                                                  ],
                                                                ),
